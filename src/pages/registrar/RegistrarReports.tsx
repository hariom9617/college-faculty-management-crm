...
export default function RegistrarReports() {
  ...
  const [selectedReport, setSelectedReport] = useState<LectureReport | null>(
    null
  );
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 animate-fade-in">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Complete lecture reports across all departments
            </p>
          </div>
        ...
        {/* Table */}
        <div
          className="bg-card rounded-xl border border-border/50 shadow-card overflow-hidden animate-slide-up"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Badge variant="outline" className="mt-1">
                      {selectedReport.faculty?.department || "Unknown"}
                    </Badge>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Faculty</p>
                    <p className="font-medium">
                      {selectedReport.faculty?.name || "Unknown"}
                    </p>
                  </div>
                  <div>
